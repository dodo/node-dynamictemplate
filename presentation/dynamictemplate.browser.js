  ...
  Template = (function() {
    ...
    function Template(opts, template) {
      ...
      this.xml.query = function(type, tag, key) {
        var _ref7;
        if (type === 'tag') {
          console.error("Q DT " + type + " " + tag + " " + key);
